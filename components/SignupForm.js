...
function SignupForm() {
  ...
  async function Signup() {
    try {
      ...
      if (password === confirmpassword) {
        ...
        let result = await fetch("https://localhost:44392/api/Signup", {
          method: "POST",
  ...
  async function Check() {
    try {
      if (password === confirmpassword) {
        let item1 = { email }
        let result1 = await fetch('https://localhost:44392/api/Signup/CheckEmailExist', {
          method: "POST",
  ...
  function Validate2() {
    try {
      ...
      if (!mobileregex.test(mobile)) {
        ...
        seterrorMsg1("Please enter an valid Mobile Number");
        return false;
      }
      seterrorMsg1("");
      return true;
  ...
  function Validate5()
{
  try {
    if (mobile === '0000000000') {
      seterrorMsg4("please Enter valid Number");
      return false;
    }
    seterrorMsg4("");
    return true;
  ...
  return (
    <MDBContainer fluid className='p-4  background-radial-gradient overflow-hidden' style={{ height: '800px' }}>
      ...
      <MDBRow>
        ...
        <MDBCol md='6' className='position-relative'>
          ...
          <MDBCard className='my-5 bg-glass' style={{ top: "100px" }}>
            <MDBCardBody className='p-5'>
              ...
              {emailExist ? <p>Email Already Exist Login to Continue</p> : ""}
